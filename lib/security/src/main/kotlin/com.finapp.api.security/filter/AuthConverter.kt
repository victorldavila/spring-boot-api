...
import com.finapp.api.security.Security
...
class AuthConverter : ServerAuthenticationConverter {
    ...
    private fun isBearerToken(header: String) = header.trim().isNotEmpty() && header.trim().startsWith(Security.Header.AUTH_PREFIX)
}