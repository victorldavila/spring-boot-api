...
data class ProductCombinationItemRequest(
    @field:NotBlank(groups = [ OnCreate::class ], message = "Product Combination item name can not be blanked")
    ...
    @field:NotNull(groups = [ OnCreate::class ], message = "sProduct Combination item quantity can not be null")
    @JsonProperty("quantity") val quantity: Int?,
    @field:NotNull(groups = [ OnCreate::class ], message = "Product Combination item isActive can not be null")
    @JsonProperty("isActive") val isActive: Boolean?,
    @field:ObjectId(groups = [ OnCreate::class ], message = "product id must be valid")
